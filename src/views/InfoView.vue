        ...
        <div class="row">
              ...
              <div class="row">
                <div class="col">
                  <span
                    class="coin-img"
                    :style="{
                      backgroundImage: `url('https://raw.githubusercontent.com/rainner/binance-watch/master/public/images/icons/${currency.base.toLowerCase()}_.png')`
                    }"
                  ></span>
                  <div class="coin-name">
              ...
              <div class="row">
                <div class="col-md-6">
                  <span
                    class="price"
                    :style="{
                      color: ticker.pchg && ticker.pchg > 0 ? 'green' : 'red'
                    }"
                    >{{ ticker.price
                    }}<span class="x-small"> {{ currency.quote }}</span></span
                  >
                </div>
                <div
          ...
          <div class="col-md-4 mb-3">
            <div class="info-card justify-content-center">
              <div>
                <span class="info-label">24H OPEN </span
                >{{ ticker.open | priceformat
                }}<span class="small"> {{ currency.quote }}</span>
              </div>
              <div>
                <span class="info-label">24H HIGH </span
                >{{ ticker.high | priceformat
                }}<span class="small"> {{ currency.quote }}</span>
              </div>
              <div>
                <span class="info-label">24H LOW </span
                >{{ ticker.low | priceformat
                }}<span class="small"> {{ currency.quote }}</span>
              </div>
              <div>
